const CACHE = 'biblioteca-estudio-v9';
const APP = ['./','./index.html','./login.html','./forgot-password.html','./update-password.html','./supabase-config.js','./assets/css/biblioteca.css','./assets/js/auth.js','./assets/js/adaptadores-json.js','./assets/js/biblioteca.js','./assets/js/vista-paralela.js','./manifest.webmanifest','https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2'];
